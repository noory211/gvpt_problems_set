...
The bivariate OLS analysis indicates that higher spending on education is associated with an increased literacy rate. For every one-unit increase in education spending, the literacy rate increases by 1.722 points, on average. 

::: {.callout-tip}
Please use the variable units. Also, ... holding all else constant. 
:::
...
::: {.callout-tip}
Your `union` should be 30, not 0.3. 
:::
