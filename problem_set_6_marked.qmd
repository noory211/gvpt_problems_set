...
::: {.callout-tip}
3.33 is the t-statistic, not the z-score. 
:::
...
::: {.callout-tip}
The null hypothesis must be a single point. Here it is: that the mean feeling thermometer rating for President Biden is equal to 50.
:::
